...
function BlinkExplosion:charge()
  ...
  status.setPersistentEffects("blinkexplosionability", { { stat = "invulnerable", amount = 1.0}, {stat = "activeMovementAbilities", amount = 1}, self.weapon.elementalType.."charge_es" })
